...
enum as1813_128o_thermal_sysfs_attrs {
    TEMP1_INPUT,  // MEZZ_BOT-L 0x48
    TEMP2_INPUT,  // MEZZ_BOT-R 0x48
    TEMP3_INPUT,  // MEZZ_TOP-L 0x48
    TEMP4_INPUT,  // MEZZ_TOP-R 0x48
    TEMP5_INPUT,  // MB 0x48
    TEMP6_INPUT,  // MB 0x49 
    TEMP7_INPUT,  // MB 0x4A 
    TEMP8_INPUT,  // MB 0x4B
    TEMP9_INPUT,  // MB 0x4C 
    TEMP10_INPUT, // MB 0x4D 
    TEMP11_INPUT, // CB 0x48 
    TEMP12_INPUT, // FAN_TEMP_T 0x4D
    TEMP13_INPUT, // FAN_TEMP_T 0x4E
    TEMP14_INPUT, // FAN_TEMP_B 0x4D
    TEMP15_INPUT, // FAN_TEMP_B 0x4E
};
                            ...
                            char *buf)
{
    ...
    if (time_after(jiffies, data->last_updated + HZ * 5) || !data->valid) {
        ...
        status = ipmi_send_message(&data->ipmi, &data->pdev->dev, IPMI_THERMAL_READ_CMD, NULL, 0,
